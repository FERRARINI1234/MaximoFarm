...
{
    public class CadastrarCentroReceitaCommand : Command
    {
        public int CodCentroReceita { get; private set; }
        public string DescCentroReceita { get; private set; }
        public bool Ativo { get; private set; }

        public CadastrarCentroReceitaCommand(int codCentroReceita, string descCentroReceita, bool ativo)
        {
        ...
        {
            ValidationResult = new CadastrarCentroReceitaValidation().Validate(this);
            return ValidationResult.IsValid;
        }
        internal class CadastrarCentroReceitaValidation : AbstractValidator<CadastrarCentroReceitaCommand>
        {
            public CadastrarCentroReceitaValidation()
            {
