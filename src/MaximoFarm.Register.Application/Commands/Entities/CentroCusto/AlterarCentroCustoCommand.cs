...
{
    public class AlterarCentroCustoCommand : Command
    {
        public int CodCentroCusto { get; private set; }
        public string DescCentroCusto { get; private set; }
        public bool Ativo { get; private set; }

        public AlterarCentroCustoCommand(int codCentroCusto, string descCentroCusto, bool ativo)
        {
        ...
        internal class CadastrarCentroCustoValidation : AbstractValidator<AlterarCentroCustoCommand>
        {
